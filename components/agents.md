...
**Natural Language Robotics case study** (`custom/portfolio/case-study/nl-robotics/`): narrative sections — `case-study-nl-robotics-hero` (with `case-study-nl-robotics-factory-visual`), `case-study-nl-robotics-at-a-glance`, `case-study-nl-robotics-demo-placeholders` (static `<figure>` placeholders only — no `<video>`), `case-study-nl-robotics-in-depth-transition`, `case-study-nl-robotics-technical-stack`, `case-study-nl-robotics-factory-flow`, `case-study-nl-robotics-run-comparison`, `case-study-nl-robotics-callout`, and `case-study-nl-robotics-related-harness`. Copy from `lib/portfolio/case-studies/nl-robotics.ts` only. Do not import Harness, Kinterra, Luca, or UKMe production components.
