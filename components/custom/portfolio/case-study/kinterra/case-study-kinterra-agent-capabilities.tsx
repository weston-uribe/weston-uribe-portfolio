...
import { KINTERRA_AGENT_CAPABILITY_CARDS } from "@/lib/portfolio/case-studies/kinterra";
import { cn } from "@/lib/utils";

export function CaseStudyKinterraAgentCapabilities() {
  return (
    <div className={cn(RESPONSIVE.caseStudyAnnotationGrid, "md:grid-cols-2")}>
      {KINTERRA_AGENT_CAPABILITY_CARDS.map((card) => (
